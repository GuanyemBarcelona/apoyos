...
<link rel="stylesheet" href="css/alertify.default.css" />
	...
	<?php if (isset($_POST['dni']) && ($error == '')) { ?> 
		<p class="aviso ok"><strong>Registrado con éxito. ¡Muchas gracias!</strong><br>
		Para poder tirar adelante este proyecto necesitamos reunir 30.000 firmas, ¡consigámoslo entre todas! Ahora te toca a ti animar a tus amistades a firmar por Guanyem Barcelona.<br>
		<a href="#" onClick="window.open('http://www.facebook.com/sharer.php?u=https://guanyembarcelona.cat/es/firma/&t=Firma para Guanyem Barcelona', 'facebook_share', 'height=320, width=640, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, directories=no, status=no');" class="facebook" title="facebook" rel="nofollow"><img src="https://guanyembarcelona.cat/wp-content/uploads/2014/facebook-24x24.png"></a> <a href="#" onClick="window.open('https://twitter.com/intent/tweet?original_referer=https://guanyembarcelona.cat/es/firma/&text=Para que el proyecto Guanyem Barcelona se haga realidad se necesitan 30.000 firmas. Yo acabo de firmar ¿y tú?&url=https://guanyembarcelona.cat/es/firma/', 'twitter_share', 'height=320, width=640, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, directories=no, status=no');" class="twitter" title="twitter" rel="nofollow"><img src="https://guanyembarcelona.cat/wp-content/uploads/2014/twitter-24x24.png"></a></p>
	<?php
	 	} 
	...
	?>
		...
		<form id="nuevo" action="nuevo_cast_share.php" method="post">
            ...
            <div class="check">
                ...
                <label>Quiero que mi apoyo sea visible</label>
            </div>
            <div class="check">
